        ...
        <>
            ...
            <header className="relative h-screen overflow-hidden bg-fixed bg-center bg-no-repeat bg-cover">
                <section className="container relative flex items-center h-full align-center">
                    <article className="relative flex flex-col items-start laptop:ml-12 desktop:ml-28 widescreen:ml-40">
                        <h1 className="font-serif font-bold leading-tight text-white laptop:text-5xl laptop:w-7/12 widescreen:w-7/12 widescreen:text-6xl">
